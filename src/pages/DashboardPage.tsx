...
import { BarChart3, Wallet, CreditCard, Vote, History, ArrowUpRight, TrendingUp } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              ...
              <Button className="bg-teal-500 hover:bg-teal-600 h-auto py-6 flex flex-col items-center gap-2" asChild>
