...
import {
  ...
  FinancialProfile,
  FinancialRecommendations as RecommendationsType,
} from "@/services/financialAdvisorService";
  ...
  const generateRecommendations = async (profileData: FinancialProfile) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your personalized financial recommendations have been generated.",
      });
    } catch (error) {
        ...
        <div className="container mx-auto px-4 py-8">
          <header className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Get personalized savings and investment recommendations tailored
