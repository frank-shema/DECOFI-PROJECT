...
const FinancialProfileForm: React.FC<FinancialProfileFormProps> = ({
  ...
  const updateGoal = (index: number, field: string, value: unknown) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setProfile({ ...profile, expenses: Number(e.target.value) })
                }
                min="0"
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setProfile({ ...profile, savings: Number(e.target.value) })
                }
                min="0"
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                value={profile.debt}
                onChange={(e) =>
                  setProfile({ ...profile, debt: Number(e.target.value) })
                }
                min="0"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value: "low" | "medium" | "high") =>
                  setProfile({ ...profile, riskTolerance: value })
                }
              >
                <SelectTrigger>
            ...
            {profile.goals.map((goal, index) => (
              ...
              >
                ...
                <CardContent className="p-4 pt-2 space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor={`goal-amount-${index}`}>
                      Target Amount ($)
                    </Label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <Label htmlFor={`goal-timeframe-${index}`}>
                      Timeframe (years): {goal.timeframe}
                    </Label>
                    <Slider
                      ...
                      onValueChange={([value]) =>
                        updateGoal(index, "timeframe", value)
                      }
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <RadioGroup
                      value={goal.priority}
                      onValueChange={(value: "low" | "medium" | "high") =>
                        updateGoal(index, "priority", value)
                      }
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem
                          value="low"
                          id={`priority-low-${index}`}
                        />
                        <Label
                          htmlFor={`priority-low-${index}`}
                      ...
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem
                          value="medium"
                          id={`priority-medium-${index}`}
                        />
                        <Label
                          htmlFor={`priority-medium-${index}`}
                          className="cursor-pointer"
                        >
                          Medium
                        </Label>
                      ...
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem
                          value="high"
                          id={`priority-high-${index}`}
                        />
                        <Label
                          htmlFor={`priority-high-${index}`}
                          className="cursor-pointer"
                        >
                          High
                        </Label>
